...
namespace ParcelForce.Test.Common.Entities.Mappers
{
    ...
    public abstract class EntityMapper<TProviderEntity, TServiceEntity>
        where TProviderEntity :ParcelForce.Test.Common.BaseEntities.ProviderEntityBase
        where TServiceEntity :ParcelForce.Test.Common.BaseEntities.ServiceEntityBase
    {
